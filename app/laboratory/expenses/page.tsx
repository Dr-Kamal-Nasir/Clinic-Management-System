            ...
            {isLoading ? (
              ...
              filteredExpenses.map((expense: Expense) => (
                <TableRow key={expense._id}>
                  ...
                  <TableCell>
                    {expense.expenseType === 'doctor_salary' ? 'Doctor Salary' : 'Normal Expense'}
                  </TableCell>
                  <TableCell>{expense.doctorName || '-'}</TableCell>
                  <TableCell>${expense.amount.toFixed(2)}</TableCell>
                  <TableCell>
                    {expense.expenseType === 'doctor_salary' && (
                      <span>
                        {expense.percentage ? `${expense.percentage}% of $${expense.calculatedFromRecords?.toFixed(2)}` : 'Full amount'}
                      </span>
                    )}
                  </TableCell>
                  <TableCell>
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="grid gap-4 py-4">
            ...
            {expenseType === 'doctor_salary' && (
              <>
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right">Doctor Name*</Label>
                  <Input
                    value={doctorName}
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant="outline"
                        className={cn("col-span-3 justify-start text-left font-normal", !fromDate && "text-muted-foreground")}
                      >
                        <CalendarIcon className="mr-2 h-4 w-4" />
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant="outline"
                        className={cn("col-span-3 justify-start text-left font-normal", !toDate && "text-muted-foreground")}
                      >
                        <CalendarIcon className="mr-2 h-4 w-4" />
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right">Calculate Salary</Label>
                  <Button 
                ...
                {calculatedAmount > 0 && (
                  <>
                    <div className="grid grid-cols-4 items-center gap-4">
                      <Label className="text-right">Total Collected</Label>
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                      <Label className="text-right">Doctor Percentage</Label>
